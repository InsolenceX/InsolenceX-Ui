...
local LunaUI = isStudio and script.Parent:WaitForChild("Insolence UI") or game:GetObjects("rbxassetid://86467455075715")[1]
...
function Luna:CreateWindow(WindowSettings)
	...
	LoadingFrame.Version.Text = LoadingFrame.Frame.Frame.Title.Text == "Luna Interface Suite" and Release or "Insolence UI"
